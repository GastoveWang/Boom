"""
==============================================================================
Boom 資料工具鏈 - 視訊影格提取與標註前處理工具 (video_to_frames.py)
==============================================================================

【工具定位】
將無人機原始航拍視訊（MP4, MOV 等）自動切分為單幀高解析度圖像（PNG / JPG），
作為 X-AnyLabeling 標註工具或 YOLO 模型訓練的樣本來源。

【核心功能】
- 支援等間隔抽幀（例如每 0.5 秒抽一張）或逐幀提取。
- 自動建立專屬儲存目錄，重名自動遞增流水號（如 _2, _3），不覆蓋既有樣本。

【執行範例】
python tools/video_to_frames.py "data/raw_video/example.mp4" --interval 0.5
==============================================================================
"""
