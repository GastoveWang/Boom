"""
==============================================================================
Boom 航拍定位 - 地圖導航微縮元件與指北羅盤 (map_widgets.py)
==============================================================================

【檔案定位】
本檔案提供地圖面板中輔助導航的小型 Widget 元件，包含台灣全島地理概覽圖、
動態視野指北羅盤、以及相機光軸水平朝向錐形射線。

【核心元件】
- `draw_taiwan_overview`: 繪製台灣全島地圖並以矩形框標示當前無人機所在區域。
- `draw_compass`: 繪製即時旋轉的專業級航海指北羅盤。
- `draw_camera_direction`: 繪製相機水平光軸朝向引導扇形。
- `draw_navigation_card`: 組合概覽圖與羅盤為整合式導航資訊卡。
==============================================================================
"""
import json
import math
...
import cv2
import numpy as np
from boom.config.defaults import PROJECT_ROOT
from boom.ui.drawing import _draw_text_inplace
from boom.ui.theme import SURFACE, BORDER, ACCENT, TEXT, rounded_surface
from .geometry import camera_heading
...
def camera_bearing(rotation):
    ...
    return camera_heading(rotation)
