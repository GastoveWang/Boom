"""
==============================================================================
Boom 航拍定位 - 地圖視窗渲染與動態追蹤畫布 (map_panel.py)
==============================================================================

【檔案定位】
本檔案負責地圖視覺化面板的渲染繪製，包含高動態範圍 GeoTIFF 底圖裁剪縮放、
無人機即時航跡線、旋轉姿態圖標、相機視野錐體（FoV Frustum）、以及煙霧源地面標記。

【核心功能】
- `render_panel(...)`: 生成以無人機為中心或自動調整範圍的航拍地圖面板底圖。
- `_draw_rotated_drone_icon`: 繪製依據航向角旋轉的高對比無人機圖示與雷達光圈。
- 繪製平滑航跡歷史曲線與煙霧事件標記圖示。
==============================================================================
"""
