"""Legacy coordinate side panels and map event panel rendering."""
...
from artillery.common.defaults import PANEL_WIDTH
from artillery.common.events import LoggedEvent
from artillery.offline.src.ui.drawing import _draw_text_inplace
