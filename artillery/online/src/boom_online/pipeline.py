...
from artillery.offline.src.detectors.optical_flow_smoke_detector import ConfirmedEvent, InstantSmokeDustDetector
from artillery.online.src.spinnaker_camera import LatestFrameGrabber, SpinCamera, SpinCameraConfig
